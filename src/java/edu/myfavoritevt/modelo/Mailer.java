package edu.myfavoritevt.modelo;
...
public class Mailer {
    ...
    public static void sendClaves(String para, String Nombres, String correoUsu, String clave) {
        final String user = "promyfavoritevet@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "veterinario123";
...
//2nd paso)compose message
        try {
            ...
            message.setSubject("Recuperar contraseña My Favorite Vet");

            message.setContent(
                    "<center><img src='https://raw.githubusercontent.com/joenilson/autorizar_descuento/master/logo_autorizacion_descuentos.png' title='Claves'></center>"
...
//2nd paso)compose message
    ...
    public static void sendBienvenido(String para, String Nombres, String correoUsu, String clave) {
        final String user = "myfavoritevet2018@gmail.com";//cambiará en consecuencia al servidor utilizado
        final String pass = "veterinario123";
...
//2nd paso)compose message
        try {
            ...
            message.setFrom(new InternetAddress(user));
            message.addRecipient(Message.RecipientType.TO, new InternetAddress(para));
            message.setSubject("Bienvenido a My Favorite Vet.");

            message.setContent(
                    "<center><img src='https://sig.redgama.com:98/common/recordar-contrase%C3%B1a-outlook.png' title='bv'></center>"
                    + "<h3> Bienvenido al sistema de informacion My Favorite Vet. "
                    + Nombres
                    + "</h3>"
                    + "Datos de Ingreso: "
                    + "<h4> Coorreo Usuario : "
